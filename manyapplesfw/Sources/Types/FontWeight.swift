...
extension AFont {
  public static func systemFontOfSize(_ fontSize: CGFloat, weight: FontWeight) -> AFont {
    #if os(iOS) || os(tvOS) || os(watchOS)
      return AFont.systemFont(ofSize: fontSize, weight: UIFont.Weight(rawValue: weight.weight))
    #else
