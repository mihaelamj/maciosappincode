...
//  Original source: https://github.com/soffes/X
  ...
  extension AFont {
    public static func preferredFont(forTextStyle textStyle: AFontTextStyle) -> AFont {
      return AFont.systemFontOfSize(textStyle.pointSize, weight: textStyle.fontWeight)
    }
  }
#endif
